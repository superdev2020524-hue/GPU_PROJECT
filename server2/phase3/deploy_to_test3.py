#!/usr/bin/env python3
"""
Deploy phase3 guest shims to the VM and get Ollama into vGPU mode.

Uses SCP for all file transfers (no chunked/base64) to avoid corruption.
Reads VM target from vm_config.py (e.g. test_4@10.25.33.12). See SETUP_TEST4_CHECKLIST.md for full new-VM setup.
