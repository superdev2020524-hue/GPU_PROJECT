...
char *fgets(char *s, int size, FILE *stream)
{
    ...
    /* NOTE: Duplicate code blocks have been removed. The following sections were duplicates:
     * - skip_flag handling (already at lines 1720-1764)
     * - is_application_process() check (already at lines 1767-1784)
     * - real_fgets declaration (already at line 1787)
     * - File tracking logic (already at lines 1800-1947)
     * All this code is already handled above, so we proceed directly to the PCI file interception. */
