...
cublasStatus_t cublasGetVersion_v2(cublasHandle_t handle, int *version)
{
    ...
    if (is_stub_handle(handle)) { *version = 0; return reject_stub_handle_compute("cublasGetVersion_v2"); }
    if (is_remote_handle(handle)) {
        (void)handle;
        *version = 12080;
        return CUBLAS_STATUS_SUCCESS;
    ...
    typedef cublasStatus_t (*fn_t)(cublasHandle_t, int *);
    RESOLVE_OR_FALLBACK("cublasGetVersion_v2", fn_t, CUBLAS_STATUS_NOT_INITIALIZED);
    return real_fn(handle, version);
}
...
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCaxpy_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCdgmm)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCdotc_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCdotu_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCgeam)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCgelsBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCgemmBatched)
...
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCgerc_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCgeru_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCgetrfBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCgetriBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCgetrsBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCscal_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCsscal_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCsyrk_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCtrsmBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasCtrsm_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDasum_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDaxpy_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDdgmm)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDdot_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDgeam)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDgelsBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDgemmBatched)
...
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDger_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDgetrfBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDgetriBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDgetrsBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDnrm2_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDotEx)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDsbmv_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDscal_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDsyrk_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDtpttr)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDtrsmBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDtrsm_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDtrttp)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDzasum_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasDznrm2_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasIcamax_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasIcamin_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasIdamax_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasIdamin_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasIsamax_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasIsamin_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasIzamax_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasIzamin_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSasum_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSaxpy_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasScasum_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasScnrm2_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSdgmm)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSdot_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSgeam)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSgelsBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSgemmBatched)
...
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSger_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSgetrfBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSgetriBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSgetrsBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSnrm2_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSsbmv_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSscal_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasSsyrk_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasStpttr)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasStrsm_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasStrttp)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZaxpy_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZdgmm)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZdscal_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZdotc_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZdotu_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZgeam)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZgelsBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZgemmBatched)
...
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZgerc_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZgeru_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZgetrfBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZgetriBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZgetrsBatched)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZscal_v2)
DEFINE_CUBLAS_NOT_SUPPORTED_EXPORT(cublasZsyrk_v2)
